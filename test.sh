...
python3 ${zero}/scripts/checkpoint_averaging.py --path /home/user/staehli/master_thesis/zero/checkpoints/afs-tf --output /home/user/staehli/master_thesis/zero/checkpoints/ --checkpoints 5 --gpu 5
