...
#python $zero/scripts/checkpoint_averaging.py --path /home/user/staehli/master_thesis/zero/checkpoints/afs-tf --output /home/user/staehli/master_thesis/ --checkpoints 5 --gpu 0
...
#enable_afs_t=True,enable_afs_f=True,\
#clip_grad_norm=0.0,\
#num_heads=8,\
#process_num=4,\
#lrate=1.0,\
...
#output_dir="/home/user/staehli/master_thesis/",\
